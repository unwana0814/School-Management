...
<div class="ml-auto bg-gray-200 shadow justify-content-center p-3 mt-5">
    ...
    <div class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
		<div class="max-w-md w-6/12 space-y-8">
			<div>
				<img class="mx-auto h-12 " src="../Images/galleries.jpg" alt="Workflow">
    ...
    <form action="{{ route('categories.update', $category->id) }}" method="POST" style='width:400px' class=' w-full max-w-sm mx-auto my-20'>
    @csrf
    
        <div class="flex items-center border-b border-teal-500 py-2">
          <input class="appearance-none bg-transparent border-none w-full text-gray-700 mr-3 py-3 px-2 leading-tight focus:outline-none" type="text" placeholder="Name" value="{{ $book->name }}" aria-label="name">
        </div>
