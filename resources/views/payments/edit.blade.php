...
<div class="ml-auto bg-gray-200 shadow justify-content-center p-3 mt-5">
    ...
    @method('PUT')
        ...
        <div class="flex items-center border-b border-teal-500 py-2">
          <input class="appearance-none bg-transparent border-none w-full text-gray-700 mr-3 py-3 px-2 leading-tight focus:outline-none" type="text" name="name"  placeholder="Name" value="{{ $grade->name }}" aria-label="name">
        </div>

        <div class="flex items-center border-b border-teal-500 py-2">
            <input class="appearance-none bg-transparent border-none w-full text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none" type="text" name="type" placeholder="Type" value="{{ $grade->type }}" aria-label="type">
          </div>

          <div class="flex items-center border-b border-teal-500 py-2">
            <input class="appearance-none bg-transparent border-none w-full text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none" type="text" name="score"  placeholder="Score" value="{{ $grade->score }}" aria-label="score">
          </div>
