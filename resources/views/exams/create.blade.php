...
<div class="ml-auto bg-gray-200 shadow justify-content-center p-3 mt-5">
    ...
    <form action="{{ route('exams.store') }}" method="POST" style='width:400px' class='w-full max-w-sm'>
    @csrf
        ...
        <div class="flex items-center border-b border-teal-500 py-2">
          ...
          <div class="flex items-center border-b border-teal-500 py-2">
            <input class="appearance-none bg-transparent border-none w-full text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none" type="text" name="deadline"  placeholder="deadline" aria-label="deadline"><i class="fa fa-calendar" aria-hidden="true"></i>
          </div>
